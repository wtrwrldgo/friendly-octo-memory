...
export class SubscriptionService {
  async getSubscriptionStatus(firmId: string): Promise<SubscriptionInfo> {
  ...
  async checkAndUpdateTrialStatus(firmId: string): Promise<SubscriptionInfo> {
  ...
  private checkAccess(status: SubscriptionStatus, isTrialExpired: boolean): boolean {
