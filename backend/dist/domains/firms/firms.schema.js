import { z } from 'zod';
const urlOrPath = z.string().refine((val) => val.startsWith('http://') || val.startsWith('https://') || val.startsWith('/'), { message: 'Must be a valid URL or path starting with /' });
...
//# sourceMappingURL=firms.schema.js.map