...
export class FirmsRepository {
    ...
    async create(data) {
        ...
        Object.keys(firmDataSnake).forEach(key => {
            if (firmDataSnake[key] === undefined)
                delete firmDataSnake[key];
        });
    ...
    async update(id, data) {
        ...
        if (data.homeBannerUrl !== undefined)
            updateData.home_banner_url = data.homeBannerUrl;
        if (data.detailBannerUrl !== undefined)
            updateData.detail_banner_url = data.detailBannerUrl;
        if (data.description !== undefined)
            updateData.description = data.description;
        if (data.address !== undefined)
            updateData.address = data.address;
        if (data.deliveryTime !== undefined)
            updateData.delivery_time = data.deliveryTime;
        if (data.minOrder !== undefined)
            updateData.min_order = data.minOrder;
        if (data.minOrderEnabled !== undefined)
            updateData.min_order_enabled = data.minOrderEnabled;
        if (data.deliveryFee !== undefined)
            updateData.delivery_fee = data.deliveryFee;
        if (data.deliveryFeeEnabled !== undefined)
            updateData.delivery_fee_enabled = data.deliveryFeeEnabled;
        if (data.deliveryFeeType !== undefined)
            updateData.delivery_fee_type = data.deliveryFeeType;
        if (data.deliveryFeePercent !== undefined)
            updateData.delivery_fee_percent = data.deliveryFeePercent;
        if (data.bottleDeposit !== undefined)
            updateData.bottle_deposit = data.bottleDeposit;
        if (data.bottleDepositEnabled !== undefined)
            updateData.bottle_deposit_enabled = data.bottleDepositEnabled;
        if (data.bottleDepositPrice !== undefined)
            updateData.bottle_deposit_price = data.bottleDepositPrice;
        if (data.scheduleDaysLimit !== undefined)
            updateData.schedule_days_limit = data.scheduleDaysLimit;
        if (data.scheduleTimeInterval !== undefined)
            updateData.schedule_time_interval = data.scheduleTimeInterval;
        if (data.isActive !== undefined)
            updateData.is_active = data.isActive;
        if (data.status !== undefined)
            updateData.status = data.status;
        if (data.isVisibleInClientApp !== undefined)
            updateData.is_visible_in_client_app = data.isVisibleInClientApp;
        if (data.submittedAt !== undefined)
            updateData.submitted_at = data.submittedAt;
...
//# sourceMappingURL=firms.repository.js.map