...
function getTranslatedName(product, language) {
    const langMap = {
        en: product.name_en,
        ru: product.name_ru,
        uz: product.name_uz,
...
function transformProduct(product, language) {
    return {
        id: product.id,
...
export const productsService = {
    ...
    async update(id, data, firmId) {
        ...
        if (data.name_kaa !== undefined)
            updateData.name_kaa = data.name_kaa;
        ...
        if (data.inStock !== undefined)
            updateData.in_stock = data.inStock;
